    ...
    def from_pretrained(cls, pretrained_model_name, *inputs, **kwargs):
        ...
        try:
            # resolved_archive_file = cached_path(archive_file)
              resolved_archive_file='/home/yx/medical-vqa/bert_json/9c41111e2de845' \
                                    '47a463fd39217199738d1e3deb72d4fec4399e6e241983c6f0.ae3c' \
                                    'ef932725ca7a30cdcb93fc6e09150a55e2a130ec7af63975a16c153ae2ba'
