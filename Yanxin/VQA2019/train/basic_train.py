...
def Modality_train():
    ...
    for epoch in range(config.epoch):
        ...
        print('\n')
        print('train epoch={}/{},train loss=: {},train acc=: {}'.format(epoch,config.epoch,total_loss,total_acc))
        print('\n')
        torch.save(model,'../log/Modality/'+'ckpt_'+str(epoch)+'.pth')
        Modality_val(epoch)
...
def Modality_val(ckpt_id):
    ...
    print('load model ckpt_{}'.format(ckpt_id))
    model=torch.load('../log/Modality/'+'ckpt_'+str(ckpt_id)+'.pth').to(config.device)
    ...
    print('train loss=: {},train acc=: {}'.format(total_loss,total_acc))
    print('\n')
    print('\n')
